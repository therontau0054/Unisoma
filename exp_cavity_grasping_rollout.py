...
from data_loaders.cavity_grasping import DataLoader_Cavity_Grasping_Rollout
...
def train(data_path, net, config, normalizers, criterion):
    ...
    train_data_loader = DataLoader_Cavity_Grasping_Rollout(
        data_path = data_path,
        mode = "train"
    )

    eval_data_loader = DataLoader_Cavity_Grasping_Rollout(
        data_path = data_path,
        mode = "eval"
    )
...
def test(data_path, net, config, normalizers, criterion):
    ret_save_path = f"{data_root}/ret/{model_name}_cavity_grasping_rollout_{version}.pkl"
    test_data_loader = DataLoader_Cavity_Grasping_Rollout(
        data_path = data_path,
        mode = "test"
    )
...
if __name__ == "__main__":
    ...
    # setsid python -u exp_cavity_grasping_rollout.py &