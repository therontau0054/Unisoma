...
from data_loaders.tissue_manipulation import DataLoader_Tissue_Manipulation_LongTime
...
def train(data_path, net, config, normalizers, criterion):
    ...
    train_data_loader = DataLoader_Tissue_Manipulation_LongTime(
        data_path = data_path,
        mode = "train"
    )

    eval_data_loader = DataLoader_Tissue_Manipulation_LongTime(
        data_path = data_path,
        mode = "eval"
    )
...
def test(data_path, net, config, normalizers, criterion):
    ret_save_path = f"{data_root}/ret/{model_name}_tissue_manipulation_longtime_{version}.pkl"
    test_data_loader = DataLoader_Tissue_Manipulation_LongTime(
        data_path = data_path,
        mode = "test"
    )
...
if __name__ == "__main__":
    ...
    # setsid python -u exp_tissue_manipulation_longtime.py &