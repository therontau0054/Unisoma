...
from data_loaders.bilateral_stamping import DataLoader_Bilateral_Stamping_LongTime
...
def train(data_path, net, config, normalizers, criterion):
    ...
    train_data_loader = DataLoader_Bilateral_Stamping_LongTime(
        data_path = data_path,
        mode = "train"
    )

    eval_data_loader = DataLoader_Bilateral_Stamping_LongTime(
        data_path = data_path,
        mode = "eval"
    )
...
def test(data_path, net, config, normalizers, criterion):
    ret_save_path = f"{data_root}/ret/{model_name}_bilateral_stamping_longtime_{version}.pkl"
    test_data_loader = DataLoader_Bilateral_Stamping_LongTime(
        data_path = data_path,
        mode = "test"
    )
...
if __name__ == "__main__":
    config_path = "./configs/bilateral_stamping.toml"
    ...
    # setsid python -u exp_bilateral_stamping_longtime.py &