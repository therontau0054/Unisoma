...
from data_loaders.rice_grip import DataLoader_Rice_Grip_Rollout
...
def train(data_path, net, config, normalizers, criterion):
    ...
    train_data_loader = DataLoader_Rice_Grip_Rollout(
        data_path = data_path,
        mode = "train"
    )

    eval_data_loader = DataLoader_Rice_Grip_Rollout(
        data_path = data_path,
        mode = "eval"
    )
...
def test(data_path, net, config, normalizers, criterion):
    ret_save_path = f"{data_root}/ret/{model_name}_rice_grip_rollout_{version}.pkl"
    test_data_loader = DataLoader_Rice_Grip_Rollout(
        data_path = data_path,
        mode = "test"
    )
...
if __name__ == "__main__":
    config_path = "./configs/rice_grip.toml"
    ...
    # setsid python -u exp_rice_grip_rollout.py &